...
function _createMails() {
    ...
    if (!mails || !mails.length) {
        let mails = [
            ...
            _createMail('Client Feedback', 'Got some feedback from the client. Not major, but we might want to tweak a few things in the design.', 1681722220000, null, 'Tom-shahar@gmail.com', 'natalie@studio.io', 'sent'),
            ...
            _createMail('Design Concepts', 'Attached are the initial concepts for the mobile layout. Let me know which one stands out.', 1681725550000, null, 'kelly@creativehub.com', 'Tom-shahar@gmail.com', 'inbox'),
            ...
            _createMail('Launch Plan', 'Here’s the updated timeline and checklist for launch day. Let’s keep things tight and smooth!', 1681727770000, null, 'emma@launchlab.com', 'Tom-shahar@gmail.com', 'inbox'),
            ...
            _createMail('Design Feedback', 'Loved the second option. Just a few color tweaks and it should be good to go!', 1681729990000, null, 'lucas@startuphub.io', 'Tom-shahar@gmail.com', 'inbox'),
            ...
            _createMail('Legal Review', 'I reviewed the contract. There are some clauses we might want legal to take another look at.', 1681732000000, null, 'claire@legalmail.com', 'Tom-shahar@gmail.com', 'inbox'),
            ...
            _createMail('User Feedback Summary', 'Compiled the user feedback from our last survey. Some actionable points in there.', 1681735000000, null, 'alex@researchlab.com', 'Tom-shahar@gmail.com', 'inbox'),
            ...
            _createMail('Onboarding Checklist', 'This checklist should help new hires get started quickly. Let me know if I missed anything.', 1681741000000, null, 'sophie@hrhub.org', 'Tom-shahar@gmail.com', 'inbox'),
            _createMail('System Downtime', 'There’ll be scheduled maintenance on Saturday. Expect around 30 minutes of downtime.', 1681742000000, null, 'Tom-shahar@gmail.com', 'it@sysmail.com', 'sent'),
            ...
            _createMail('Product Feedback', 'Really like the new update! Only issue is syncing across devices isn’t working consistently.', 1681748000000, null, 'kevin@productusers.com', 'Tom-shahar@gmail.com', 'inbox'),
